...
public class AndroidAccountManager extends BroadcastReceiver {
     ...
     */
    private static void hideScreen(Screen s) {
        try {
     ...
     * @param screen
     */
    public static Account addNewFunambolAccount(String accountName,
        ...
        if (existingAccount != null) {
            ...
            try {
                ...
                Enumeration sources = controller.getAppSyncSourceManager()
                        .getWorkingSources();
                ...
                while(sources.hasMoreElements()) {
                    ...
                    SyncAnchor anchor = sc.getSyncAnchor();
                    anchor.reset();
        ...
        if (am.addAccountExplicitly(account, null, null)) {
            ...
            // Notify all the registered sources that the account has been created.
            // Each source may need to perform extra initializations at this point
            AndroidAppSyncSourceManager appSyncSourceManager =
                    (AndroidAppSyncSourceManager)controller.getAppSyncSourceManager();
            ...
            while(sources.hasMoreElements()) {
                ...
                appSource.accountCreated(accountName, accountType);
            }
        }
