...
public class CalendarChangesTrackerMD5 extends CalendarChangesTracker {
    ...
    public CalendarChangesTrackerMD5(Context context, StringKeyValueStore status,
                                     CalendarAppSyncSourceConfig appSyncSourceConfig) {
        super(context, status, appSyncSourceConfig);
    }
    ...
    protected String computeFingerprint(String key, Cursor cursor) throws IOException {
        ...
        try {
            ...
            if (hasRem == 1) {
                ...
                Cursor rems = resolver.query(CalendarManager.Reminders.CONTENT_URI, fields, whereClause,
                                             whereArgs, null);
