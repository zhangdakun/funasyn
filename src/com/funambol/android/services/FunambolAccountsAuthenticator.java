    ...
    private class AccountAuthenticator extends AbstractAccountAuthenticator {
        ...
        private Class getAuthenticatorActivityClass() {
            ...
            if (BuildInfo.UNIT_TEST) {
                Class testScreenClass = null;
                try {
                    testScreenClass = Class.forName("com.funambol.android.UnitTestAuthenticator");
                    if (Log.isLoggable(Log.TRACE)) {
                        Log.trace(TAG, "testScreenClass = " + testScreenClass);
                    }
                    return testScreenClass;
                } catch (Exception e) {
                    Log.error(TAG, "Cannot find account screen class "
