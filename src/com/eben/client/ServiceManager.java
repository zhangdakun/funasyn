...
public final class ServiceManager {
    ...
    public ServiceManager(Context context) {
        ...
        if (context instanceof Activity) {
            Log.info(LOGTAG, "Callback Activity...");
        ...
        Log.info(LOGTAG, "apiKey=" + apiKey);
        Log.info(LOGTAG, "xmppHost=" + xmppHost);
        Log.info(LOGTAG, "xmppPort=" + xmppPort);
        ...
        editor.commit();
        // Log.info(LOGTAG, "sharedPrefs=" + sharedPrefs.toString());
    }
    ...
    public void startService(final String user) {
        Thread serviceThread = new Thread(new Runnable() {
            @Override
            public void run() {
                Intent intent = NotificationService.getIntent();
                intent.putExtra(Constants.PARA_USER, user);
                context.startService(intent);
            }
        });
        serviceThread.start();
    ...
    private Properties loadProperties() {
        ...
        try {
            ...
            Log.error(LOGTAG, "Could not find the properties file.", e);
            // e.printStackTrace();
        }
        return props;
    }
