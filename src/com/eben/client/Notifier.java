...
public class Notifier {
    ...
    public void notify(String notificationId, String apiKey, String title,
        ...
        Log.debug(LOGTAG, "notify()...");

        Log.debug(LOGTAG, "notificationId=" + notificationId);
        Log.debug(LOGTAG, "notificationApiKey=" + apiKey);
        Log.debug(LOGTAG, "notificationTitle=" + title);
        Log.debug(LOGTAG, "notificationMessage=" + message);
        Log.debug(LOGTAG, "notificationUri=" + uri);
        ...
        if (isNotificationEnabled()) {
            ...
            Log.info(LOGTAG, "Notificaitons disabled.");
        }
    }
