...
public class BackupProcessAdapter extends BaseAdapter
{
...
//        public TextView mPercentText;
    ...
    public BackupProcessAdapter(Context context1, int i, List list)
    {
        mapList = null;
    ...
    Handler mHandler;
    public BackupProcessAdapter(Context context1, int i, List list, Handler mHandler)
    {
        mapList = null;
        layoutInflater = LayoutInflater.from(context1);
        layoutID = i;
