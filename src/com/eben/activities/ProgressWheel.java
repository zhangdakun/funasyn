...
public class ProgressWheel extends View {
	...
	private int endBarColor = 0xAA000000;
	...
	private void setupPaints() {
		LinearGradient gradient = new LinearGradient(0, 0, 100, 100, barColor, endBarColor, Shader.TileMode.MIRROR);
	...
	private void parseAttributes(TypedArray a) {
	    ...
	    endBarColor = a.getColor(R.styleable.ProgressWheel_endbarColor, endBarColor);
...
//		new LinearGradient(0, 0, 100, 100, Color.RED, Color.YELLOW, Shader.TileMode.MIRROR);
		//
