 ...
 */
public class EbenAloneUISyncSource extends AndroidUISyncSource {
    ...
    private EbenHomeScreen homeScreen;

    public EbenAloneUISyncSource(Activity activity) {
        super(activity);
        ...
        sourceIconView.setVisibility(View.VISIBLE);
    }
    ...
    public void setHomeScreenView(EbenHomeScreen homeScreen) {
