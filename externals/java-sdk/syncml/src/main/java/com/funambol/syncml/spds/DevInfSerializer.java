...
/**
 * This class is just a utility around the SyncMLParser and formatter that can be used
 * to serialize/deserialize dev info
 */
public class DevInfSerializer {

    public DevInfSerializer() {
    }

    public String serialize(DevInf devInf) throws IOException {
        // This is just an utility around the SyncMLFormatter
    ...
    public DevInf deserialize(String devInf) throws SyncMLParserException {
        ...
        DevInf res = parser.parseXMLDevInf(devInf);
        return res;
    }
}
