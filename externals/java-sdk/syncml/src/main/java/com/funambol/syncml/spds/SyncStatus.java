...
public class SyncStatus implements SyncReport {
	 ...
	 */
	public void addReceivedItem(String guid, String luid, String cmd,
			int statusCode) {
		...
		try {
			...
			while (keys.hasMoreElements()) {
				...
				if (REQUESTED_SYNC_MODE_KEY.equals(key)) {
					...
					// The value contains the GUID, the map flag, the cmd and
					// the
					// status
					String values[] = StringUtil.split(value, ",");
	...
	public void save() throws IOException {
		...
		try {
			while (keys.hasMoreElements()) {
				String key = (String) keys.nextElement();
				SentItemStatus status = (SentItemStatus) pendingSentItems
						.get(key);

				StringBuffer v = new StringBuffer();
				v.append(status.getCmd()).append(",")
	...
	public String toString() {
		...
		res.append("| Requested sync mode: ").append(requestedSyncMode)
				.append(" - Alerted sync mode:").append(alertedSyncMode)
				.append("\n");
		res.append("|-----------------------------------------------------------------\n");
		res.append("| Total changes received from server\n");
		res.append("|-----------------------------------------------------------------\n");
		res.append("| Add: ").append(getTotalReceivedAddNumber()).append("\n");
		res.append("| Replace: ").append(getTotalReceivedReplaceNumber())
				.append("\n");
		res.append("| Delete: ").append(getTotalReceivedDeleteNumber())
				.append("\n");
		...
		res.append("| Replace: ").append(getTotalSentReplaceNumber())
				.append("\n");
		res.append("| Delete: ").append(getTotalSentDeleteNumber())
				.append("\n");
