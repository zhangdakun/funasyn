...
public class MappingManager {
    ...
    private StringKeyValueStoreFactory storeFactory = StringKeyValueStoreFactory.getInstance();

    public MappingManager(String sourceName) {
        this.sourceName = sourceName;
        store = storeFactory.getStringKeyValueStore(MAPPING_TABLE_PREFIX + sourceName);
    }
