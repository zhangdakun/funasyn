...
public class FileAdapter {
     ...
     * for both normal files and directories. If a file corresponding to newName
    ...
    /** 
     * Returns the size in bytes of this FileAdapter.
     */
    ...
    /**
     * Returns the timestamp (in milliseconds) of the last modification to the
     * file.
     */
    ...
    /**
     * Sets the hidden attribute of the current file.
     * @param hidden
     * @return true if the hidden attribute has been properly set
     * @throws IOException
     */
