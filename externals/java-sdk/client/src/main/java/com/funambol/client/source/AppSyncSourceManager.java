...
public class AppSyncSourceManager {
    ...
    protected static final String  PHOTO_TYPE             = SourceConfig.BRIEFCASE_TYPE;
    protected static final String  VIDEO_TYPE             = SourceConfig.BRIEFCASE_TYPE;
    protected static final String  FILE_TYPE              = SourceConfig.BRIEFCASE_TYPE;
    ...
    protected int getSourcePosition(int id) {
        ...
        int pos = 0;
        while(pos < order.length && order[pos] != id) {
            pos++;
        }
        return pos;
    }
