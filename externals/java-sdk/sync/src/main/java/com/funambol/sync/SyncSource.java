...
public interface SyncSource {
     ...
     * use this value.
     *
     * The value is the same as SyncML.ALERT_CODE_REFRESH_FROM_CLIENT
     */
     ...
     * use this value.
     *
     * The value is the same as SyncML.ALERT_CODE_REFRESH_FROM_SERVER
     */
    ...
    public static final int UNDEFINED_STATUS         = -1; // should not happen
